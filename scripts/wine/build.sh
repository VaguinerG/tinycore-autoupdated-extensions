...
#compile
export CFLAGS="-ftree-vectorize -fipa-pta -funroll-loops -floop-nest-optimize -Ofast -march=alderlake -mtune=alderlake"
export CXXFLAGS="-ftree-vectorize -fipa-pta -funroll-loops -floop-nest-optimize -Ofast -march=alderlake -mtune=alderlake"

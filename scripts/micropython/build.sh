...
make
make clean
CFLAGS="-fmerge-all-constants -ftree-vectorize -fipa-pta -funroll-loops -floop-nest-optimize -Ofast -march=alderlake -mtune=alderlake -flto" CXXFLAGS="-fmerge-all-constants -ftree-vectorize -fipa-pta -funroll-loops -floop-nest-optimize -Ofast -march=alderlake -mtune=alderlake -flto" make -j4
bindir=$(mktemp -d)
